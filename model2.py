...
def CConvLSTM(optimizer, layer_num, channel_num):
  ...
  encoder.add(Conv2D(32, (3,3), strides=2, activation='relu', padding='same', kernel_initializer='he_normal', input_shape=input_shape))
  encoder.add(Conv2D(32, (3,3), strides=1, activation='relu', padding='same', kernel_initializer='he_normal'))

  encoder.add(Conv2D(64, (3,3), strides=2, activation='relu', padding='same', kernel_initializer='he_normal'))
  ...
  print(concat.shape)
  convlstm = ConvLSTM2D(64, (3,3), strides=1, padding='same', activation='relu', kernel_initializer='he_normal', return_sequences=False)(concat)
  ...
  decoder.add(Conv2DTranspose(32, (3,3), strides=2, activation='relu', padding='same', kernel_initializer='he_normal'))
  decoder.add(Conv2DTranspose(32, (3,3), strides=1, activation='relu', padding='same', kernel_initializer='he_normal'))
